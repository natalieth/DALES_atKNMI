...
def create_runscript(job_name, ntasks, nnodes, walltime, work_dir, expnr):
    ...
    f.write('cd {}\n\n'.format(work_dir))
    f.write('ln -s $HOME/dales/build/src/dales4 .\n')
    f.write('ln -s $HOME/dales/data/van_genuchten_parameters.nc .\n\n')
    f.write('export LD_PRELOAD=$HOME/fixes/getcwd-autoretry-preload.so\n\n')
